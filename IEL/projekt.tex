...
\begin{titlepage}
    \begin{center}
        ...
        % Logo - uisti sa, že máš súbor na správnom mieste
...
\begin{align*}
    I_A & = 0.3620 + j0.5890 \, \si{\ampere} \\
    I_B & = 0.4070 + j0.1930 \, \si{\ampere} \\
    I_C & = 0.2630 + j0.1930 \, \si{\ampere}
\end{align*}
...
\begin{align*}
    ...
    U_{L2} & = (j44.7677) \cdot (0.2630 + j0.1930) \\
    U_{L2} & = j11.7739 + (j^2 \cdot 8.6402)       \\
    U_{L2} & = -8.6402 + j11.7739 \, \si{\volt}
\end{align*}

Výpočet modulu $|U_{L2}|$:
\begin{equation*}
    |U_{L2}| = \sqrt{(-8.6402)^2 + (11.7739)^2} \doteq \mathbf{\qty{14.6016}{\volt}}
\end{equation*}

Výpočet fázy $\varphi_{L2}$ (II. kvadrant):
\begin{align*}
    \varphi_{L2} & = 180^\circ - \arctan\left(\frac{11.7739}{8.6402}\right)            \\
    \varphi_{L2} & = 180^\circ - 53.7256^\circ \doteq \mathbf{\qty{126.2744}{\degree}}
\end{align*}
...
$$ \underbrace{K'(t) \cdot e^{-\frac{t}{200}} - \frac{1}{200} K(t) \cdot
        e^{-\frac{t}{200}}}_{u_C'(t)} + \frac{1}{200} \cdot \underbrace{\left( K(t) \cdot e^{-\frac{t}{200}} \right)}_{u_C(t)} = \frac{28}{200} $$
