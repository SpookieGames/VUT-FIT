...
\title{Quicksort}
\author{Michal Holeša \\ xholesm00@vutbr.cz}  % změn na svoje údaje
\date{\today}
...
Praktické zkušenosti a testy ukazují, že na pseudonáhodných nebo reálných datech je \textbf{Quicksort} nejrychlejší ze všech obecných řadicích algoritmů (tedy i rychlejší než \textbf{Heapsort} a \textbf{Mergesort}, které jsou formálně rychlejší). Rychlost Quicksortu však není zaručena pro všechny vstupy. Maximální časová náročnost O(N 2) Quicksort diskvalifikují pro kritické aplikace.

\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.5]{quicksort.png}
\end{center}
\caption{Graﬁcké popsíaní quicksortu. Zdroj: https://medium.com/karuna-
sehgal/a-quick-explanation-of-quick-sort-7d8e2563629b}
